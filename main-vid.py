...
frame_count = 0
frame_interval = 10  # proses setiap 10 frame
...
while True:
    ...
    if results.boxes:
        for i, box in enumerate(results.boxes):
            ...
            label_text = f"{label} ({conf_yolo:.2f})"
...
cap.release()
print("✅ Proses selesai. Semua hasil disimpan di folder:", output_dir)
